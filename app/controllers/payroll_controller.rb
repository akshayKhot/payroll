class PayrollController < ApplicationController
  ...
  def upload
    employee_report_file = params[:employee_report]
    file_num = File.basename(employee_report_file.original_filename, ".csv").split("-").last
    ...
    data = File.read(employee_report_file)
